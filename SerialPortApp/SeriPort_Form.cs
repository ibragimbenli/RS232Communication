...
{
    public partial class SeriPort_Form : Form
    {
        private SerialPort serialPort;
        public SeriPort_Form()
        {
            InitializeComponent();
        ...
        private void SerialPort_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            //byte[] byteArray = Encoding.ASCII.GetBytes(receivedDatam);
            ...
            this.Invoke((MethodInvoker)delegate
            {
                if (existing == true && NoExisting == false && cont != "01")
                {
                    ...
                    File.AppendAllText(@"C:\Users\ibrahim.benli\Desktop\SeriPortTest.txt", hexDataYaz + Environment.NewLine);
